...
Student.create(username: "Joe", password_digest: "myNameisJoe", email:'jojo18@email.com')

Student.create(username: "Melissa", password_digest: "myNameisMelissa", email:'melissa18@email.com')

Student.create(username: "Denise", password_digest: "myNameisDenise", email:'denise18@email.com')

Student.create(username: "Patrick", password_digest: "myNameisPat", email:'Patrick18@email.com')
